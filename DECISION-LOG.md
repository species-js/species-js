...
### 047 — `getDefinedConstructor` rewritten as inert pivot-and-walk with `assumePrototype` option (2026-06-09)
...
### 048 — `resolveType` lowercase-name precedence as conflict-resolution refinement (2026-06-13)
