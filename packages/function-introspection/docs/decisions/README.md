...
| [100](./0100-the-portable-half-reads-no-source.md)      | The portable half reads no source — `doesIndicateBoundFunction` drops the native-source mark, so its answer follows from the language rather than the engine | 2026-09-07 |
