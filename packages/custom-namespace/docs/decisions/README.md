...
| [098](./0098-a-namespace-is-recognized-by-reference.md)   | No `isCustomNamespace` — the caller holds the namespace, and a structural check reads a shape rather than an origin         | 2026-09-04 |
