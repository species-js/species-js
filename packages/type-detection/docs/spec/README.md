...
| primitive | frozen 2026-06-18 | —            | 23 predicates + 14 exported helpers (gate 37 = 37); decidability check passed; post-freeze amendments 2026-07-01 (symbol-registry) + 2026-07-27 (Number static-method guards relocated in by #074)                   |
| evented   | frozen 2026-06-18 | —            | 4 predicates (2 lattices) + 14 exported helpers (gate 18 = 18); decidability passed                                                                                                                                  |
...
| object    | frozen 2026-06-18 | —            | 5 predicates + 5 exported helpers (gate 10 = 10); decidability passed (fixed 1 stale doc claim); post-freeze amendments 2026-07-02 (`isAlienRealmPlainObject` exported) + 2026-08-31 (`isObjectOrCallable` added)    |
| function  | frozen 2026-06-19 | —            | 11 predicates + hasConstructSlot + 12 helpers (gate 24 = 24, incl. the three `isCurrentRealm*Instance` arms added by #080); Symbol/BigInt-as-class ruling                                                            |
| utility   | frozen 2026-06-19 | —            | 23 public readers/probes + 2 exported helpers (inert set promoted public; re-tallied 2026-08-20); decidability clean                                                                                                 |
