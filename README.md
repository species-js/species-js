...
| [`@species-js/custom-namespace`](./packages/custom-namespace)             | Frozen prototype-less namespace objects grouping exports behind one named value                       | not yet published                                                                                                                                                        |
