...
| [`@species-js/type-identity`](./packages/type-identity)                   | Type branding and tamper-resistant type identity                                                      | [![codecov](https://codecov.io/gh/species-js/species-js/branch/main/graph/badge.svg?flag=type-identity)](https://app.codecov.io/gh/species-js/species-js/flags)          |
